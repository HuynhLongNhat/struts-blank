        ...
        <div class="btn-pagination">
            <div class="previous">
                ...
                <logic:notEmpty name="T002Form" property="customers">
                    ...
                    <logic:notEqual name="T002Form" property="disabledFirst" value="true">
                ...
                <logic:notEmpty name="T002Form" property="customers">
                    <logic:equal name="T002Form" property="disabledPrevious" value="true">
                        <html:button property="btnPrevious" styleId="btnPrevious" disabled="true">&lt;</html:button>
                    </logic:equal>
                    <logic:notEqual name="T002Form" property="disabledPrevious" value="true">
                        <html:form action="/T002" method="post" style="display:inline;">
                            <html:hidden property="action" value="search"/>
            ...
            <div class="next">
                ...
                <logic:notEmpty name="T002Form" property="customers">
                    ...
                    <logic:notEqual name="T002Form" property="disabledNext" value="true">
                        <html:form action="/T002" method="post" style="display:inline;">
                            <html:hidden property="action" value="search"/>
                ...
                <logic:notEmpty name="T002Form" property="customers">
                    ...
                    <logic:notEqual name="T002Form" property="disabledLast" value="true">
                        <html:form action="/T002" method="post" style="display:inline;">
                            <html:hidden property="action" value="search"/>
        ...
        <html:form action="/T002" method="post">
            ...
            <div class="actions">
                <div class="action-group">
                    ...
                    <logic:empty name="T002Form" property="customers">
                        <html:button property="btnDelete" styleId="btnDelete" disabled="true">
                            <bean:message key="label.delete" />
                        </html:button>
                    </logic:empty>
                </div>
