    ...
    <div class="container">
        <div class="nav-group">
            ...
            <span>
                ...
                <logic:notEqual name="T003Form" property="mode" value="EDIT">
        ...
        <div class="welcome">
            <span>
                ...
                <label id="lblUserName">${user.userName}</label>
            </span>
        ...
        <div class="form-container">
            <html:form action="/T003Save" method="post" styleId="customerForm">
                ...
                <div class="form-group">
                    ...
                    <logic:present name="T003Form" property="customerId">
                        <label id="lblCustomerID">
                            <bean:write name="T003Form" property="customerId" />
                        </label>
                    </logic:present>
                ...
                <div class="form-group">
                    ...
                    <html:select property="sex" styleId="cboSex">
                        ...
                        <html:option value="0"><bean:message key="T003.label.male" /></html:option>
                        <html:option value="1"><bean:message key="T003.label.female" /></html:option>
                    </html:select>
                </div>
